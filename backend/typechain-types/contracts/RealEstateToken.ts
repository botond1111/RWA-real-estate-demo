...
export interface RealEstateTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "TOKEN_PRICE"
      | "allowance"
...
export interface RealEstateToken extends BaseContract {
  connect(runner?: ContractRunner | null): RealEstateToken;
  ...
  buyToken: TypedContractMethod<[amount: BigNumberish], [void], "nonpayable">;
  ...
  filters: {
    ...
    "PropertySold(address,uint256)": TypedContractEvent<
      PropertySoldEvent.InputTuple,
      PropertySoldEvent.OutputTuple,
      PropertySoldEvent.OutputObject
    >;
